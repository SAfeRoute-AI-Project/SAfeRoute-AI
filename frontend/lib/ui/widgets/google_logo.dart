...
class ChromeLogoIcon extends StatelessWidget {
  final double size;

  const ChromeLogoIcon({super.key, this.size = 100.0});
  ...
  Widget build(BuildContext context) {
    return SvgPicture.string(
      ...
      width: size,
      height: size,
      // Opzionale: gestire il fit se il contenitore è diverso
      fit: BoxFit.contain,
    );
  }
}

// L'SVG originale convertito in una costante Dart string
const String _chromeLogoSvg = '''
